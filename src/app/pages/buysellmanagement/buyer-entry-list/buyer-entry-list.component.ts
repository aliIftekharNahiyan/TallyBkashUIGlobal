...
@Component({
  selector: 'app-buyer-entry-list',
  templateUrl: './buyer-entry-list.component.html',
  styleUrls: ['./buyer-entry-list.component.scss']
})


export class BuyerEntryListComponent implements OnInit {
displayedColumns: string[] = ['EntryDate','BuyerName', 'Total','Discount','Cashed','Remain','Status'];
  ...
  constructor(private router: Router,private apiservice:ApigenericService,private modalService: NgbModal) { }
