...
@Component({
  selector: 'app-supplier-raw-info-details',
  templateUrl: './supplier-raw-info-details.component.html',
  styleUrls: ['./supplier-raw-info-details.component.scss']
})
export class SupplierRawInfoDetailsComponent implements OnInit {
...
this.apiservice.postData(this.apiservice.getSupplierActivityList,request)
    .subscribe(dd => {
