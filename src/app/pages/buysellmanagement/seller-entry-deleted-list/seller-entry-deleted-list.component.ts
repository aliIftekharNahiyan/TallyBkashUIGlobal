...
@Component({
  selector: 'app-seller-entry-deleted-list',
  templateUrl: './seller-entry-deleted-list.component.html',
  styleUrls: ['./seller-entry-deleted-list.component.scss']
})
export class SellerEntryDeletedListComponent implements OnInit {
