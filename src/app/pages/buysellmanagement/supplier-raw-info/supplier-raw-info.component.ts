...
@Component({
  selector: 'app-supplier-raw-info',
  templateUrl: './supplier-raw-info.component.html',
  styleUrls: ['./supplier-raw-info.component.scss']
})
export class SupplierRawInfoComponent implements OnInit {
  ...
  gotoEditPage(id){   
    this.router.navigate(['/buySellManagement/SupplierRawInfoDetails'], { queryParams: {id: btoa(id)}});
  }
  ...
  getTableData() {
    ...
    this.apiservice.getData(this.apiservice.supplierRawInfo+"?userId="+id)
    .subscribe(dd => {
